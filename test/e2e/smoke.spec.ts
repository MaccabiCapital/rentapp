...
const SIDEBAR_PATHS: Array<{ label: string; path: string }> = [
  ...
  { label: 'Late fees', path: '/dashboard/rent/late-fees' },
  { label: 'Renewals', path: '/dashboard/tenants/renewals' },
  { label: 'Renters insurance', path: '/dashboard/tenants/renters-insurance' },
  { label: 'Notices', path: '/dashboard/tenants/notices' },
  { label: 'Security deposits', path: '/dashboard/tenants/security-deposits' },
